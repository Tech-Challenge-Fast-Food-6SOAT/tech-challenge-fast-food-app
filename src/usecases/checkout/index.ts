import { Produto, Status } from "../../entities";
import { ProdutoGateway } from "../../gateways";
...
export class CheckoutUseCase {
    ...
    async checkout({ produtos, cpf }: { produtos: { id: string, quantidade: number }[], cpf: string }): Promise<{ id: string, senha: string, qrcode: string }> {
